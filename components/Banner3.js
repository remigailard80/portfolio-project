...
export default function Banner3(props) {
    const Expdata = [
        ...
        },
        {
            ...
            모두 제가 직접 하였으며, 현재도 꾸준한 리뉴얼로 최근 방명록 기능 및 에디터 기능을 추가하여 배포하였습니다. 개인적으로 배운 사실과 소소한 일기를 기록하는\
            용도로 사용하고 있습니다.',
            'thumbnail': BLOG,
        ...
        },
        {
            ...
            결국 틀에 갇히게 되기 때문입니다. 스타트업 퇴사 후, 복학하자마자 웹 개발 동아리에 지원하여 해커톤 프로젝트\
            를 위한 프로젝트 사이트 개발에서 중추적인 역할을 수행하였습니다. 초기 보일러플레이트 디자인, 기술 스택 선정을 하였고, ESLINT, HUSKY\
            등의 코드 컨벤션 관리 툴을 도입하여 오픈소스의 관리에 기여하였습니다. 위 사이트로 8월 21일에 시행된 Devkor 동아리의 해커톤을 성공적으로\
            끝마쳤으며, 메인페이지 제작, 포스팅 상세 페이지 제작, 댓글 기능 및 댓글 관련 컴포넌트 총 개발 등의 기여를 하였습니다.\
